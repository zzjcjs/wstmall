        ...
        <script>
	      ...
	      function logout(){
	    	  Plugins.confirm({ title:'信息提示',content:'您确定要退出系统吗?',okText:'确定',cancelText:'取消',okFun:function(){
	   		     ...
	   		     $.post("<?php echo U('Index/logout');?>",{},function(data,textStatus){
	   		    	  location.reload();
	   		     });
	          }});
	      }
	      function getTask(){
	    	  $.post("<?php echo U('Index/getTask');?>",{},function(data,textStatus){
	      ...
	      function cleanCache(){
	    	  ...
	    	  $.post("<?php echo U('Index/cleanAllCache');?>",{},function(data,textStatus){
	    		  var json = WST.toJson(data);
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo U('Staffs/toEditPass');?>" target='pageContent' class="btn btn-default btn-flat">修改密码</a>
                                    </div>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('GoodsCats/index');?>" target='pageContent'>商品分类</a></li>
                                <?php } ?>
                                <?php if(in_array('ppgl_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Brands/index');?>" target='pageContent'>品牌管理</a></li>
					            <?php } ?>
                                <?php if(in_array('splb_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Goods/index');?>" target='pageContent'>商品列表</a></li>
					            <?php } ?>
                                <?php if(in_array('splb_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Goods/toEdit');?>" target='pageContent'>添加商品</a></li>
                                <?php } ?>
                                <?php if(in_array('spsh_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Goods/queryPenddingByPage');?>" target='pageContent'>商品审核</a></li>
					            <?php } ?>
                                <?php if(in_array('sppl_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('GoodsAppraises/index');?>" target='pageContent'>商品评价</a></li>
					            <?php } ?>
                                <?php if(in_array('sppl_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('GoodsAppraises/index');?>" target='pageContent'>今日精选</a></li>
                                <?php } ?>
                                <?php if(in_array('sppl_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('MiaGoods/goodsCollection');?>" target='pageContent'>商品专场</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('Orders/index');?>" target='pageContent' >订单列表</a></li>
                                <?php } ?>
                                <?php if(in_array('tk_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Orders/queryRefundByPage');?>" target='pageContent' >退款列表</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('Shops/toEdit');?>" target='pageContent' >添加店铺</a></li>
                                <?php } ?>
                                <?php if(in_array('dplb_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Shops/index');?>" target='pageContent' >店铺列表</a></li>
					            <?php } ?>
                                <?php if(in_array('dpsh_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Shops/queryPeddingByPage');?>" target='pageContent' >店铺审核</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                               ...
                               <li><a href="<?php echo U('Areas/index');?>" target='pageContent' >地区管理</a></li>
                               <?php } ?>
                               <?php if(in_array('sqlb_00',$WST_STAFF['grant'])){ ?>
					           <li><a href="<?php echo U('Communitys/index');?>" target='pageContent' >社区列表</a></li>
					           <?php } ?>
                               <?php if(in_array('sqlb_01',$WST_STAFF['grant'])){ ?>
					           <li><a href="<?php echo U('Communitys/toEdit');?>" target='pageContent' >添加社区</a></li>
					           <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                               ...
                               <li><a href="<?php echo U('Articles/index');?>" target='pageContent' >文章列表</a></li>
                               <?php } ?>
                               <?php if(in_array('wzfl_00',$WST_STAFF['grant'])){ ?>
					           <li><a href="<?php echo U('ArticleCats/index');?>" target='pageContent' >文章分类</a></li>
					           <?php } ?>
                               <?php if(in_array('wzlb_01',$WST_STAFF['grant'])){ ?>
					           <li><a href="<?php echo U('Articles/toEdit');?>" target='pageContent' >添加文章</a></li>
					           <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('UserRanks/index');?>" target='pageContent' >会员等级</a></li>
                                <?php } ?>
                                <?php if(in_array('hylb_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Users/index');?>" target='pageContent' >会员列表</a></li>
					            <?php } ?>
                                <?php if(in_array('hylb_01',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Users/toEdit/');?>" target='pageContent'>添加会员</a></li>
					            <?php } ?>
                                <?php if(in_array('hyzh_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Users/queryAccountByPage');?>" target='pageContent' >账号管理</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('Roles/index');?>" target='pageContent' >角色管理</a></li>
                                <?php } ?>
                                <?php if(in_array('zylb_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Staffs/index');?>" target='pageContent' >职员管理</a></li>
					            <?php } ?>
                                <?php if(in_array('dlrz_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('LogLogins/index');?>" target='pageContent' >登录日志</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('Index/toMallConfig');?>" target='pageContent' >商城信息</a></li>
                                <?php } ?>
                                <?php if(in_array('dhgl_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Navs/index');?>" target='pageContent' >导航管理</a></li>
                                <?php } ?>
                                <?php if(in_array('yqlj_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Friendlinks/index');?>" target='pageContent'>友情链接</a></li>
					            <?php } ?>
                                <?php if(in_array('gggl_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Ads/index');?>" target='pageContent'>广告管理</a></li>
					            <?php } ?>
                                <?php if(in_array('yhgl_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Banks/index');?>" target='pageContent'>银行管理</a></li>
					            <?php } ?>
					            <?php if(in_array('zfgl_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Payments/index');?>" target='pageContent'>支付管理</a></li>
					            <?php } ?>
            ...
            <aside class="right-side">
                ...
                <section class="content" style='margin:0px;padding:0px;'>
                    <iframe id='pageContent' name='pageContent' src="<?php echo U('Index/toMain');?>" width='100%' height='100%' frameborder="0"></iframe>
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
    </body>
