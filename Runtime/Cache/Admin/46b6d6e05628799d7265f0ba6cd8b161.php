...
<form id="uploadform_Filedata" autocomplete="off" style="top:96px;position:absolute;left:122px;z-index:10;" enctype="multipart/form-data" method="POST" target="upload" action="<?php echo U('Home/Shops/uploadPic');?>" >
    <div style="position:relative;">
        <input id="brandIco" name="brandIco" class="form-control wst-ipt" type="text" value="<?php echo ($object["brandIco"]); ?>" readonly style="margin-right:4px;float:left;margin-left:8px;width:250px;"/>
        <div class="div1">
        ...
        <input type="hidden" name="fname" value="brandIco">
        <input type="hidden" id="s_Filedata" name="s_Filedata" value="">

    </div>
</form>
<form name="myform" method="post" id="myform" autocomplete="off">
    <input type='hidden' id='id' value='<?php echo ($object["cid"]); ?>'/>

    <table class="table table-hover table-striped table-bordered wst-form">
        <tr>
            <th width='120' align='right'>专场名称<font color='red'>*</font>：</th>
            <td><input type='text' id='brandName' class="form-control wst-ipt" value='<?php echo ($object["collection_describe"]); ?>' maxLength='25'/></td>
        </tr>
        <tr>
            <th width='120' align='right'>专场价格<font color='red'>*</font>：</th>
            <td><input type='text' id='brandName' class="form-control wst-ipt" value='<?php echo ($object["collection_price"]); ?>' maxLength='25'/></td>
        </tr>
        ...
        <tr>
            <th align='right'>商品列表<font color='red'>*</font>：</th>
            <td>
        ...
        <tr>
            <td colspan='2' style='padding-left:250px;'>
                ...
                <button type="button" class="btn btn-primary" onclick='javascript:location.href="<?php echo U('Admin/MiaGoods/goodsCollection');?>"'>返&nbsp;回</button>
            </td>
        </tr>
    </table>
</form>
