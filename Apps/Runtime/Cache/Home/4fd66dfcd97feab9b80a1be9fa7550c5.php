...
<html>
	<head>
     	...
     	<link rel="stylesheet" href="/Apps/Home/View/default/css/checkorderinfo.css" />
                ...
                <div id="succeed">
                    <div class="success2" style="">
                        ...
                        <div class="wst-chkod-step">
                            <img src="/Apps/Home/View/default/images/step2.png" alt="" /><br />
                        ...
                        <div id="newaddress">
                            ...
                            <?php if(count($payments['onlines']) > 0): ?><div>
                                ...
                                <div style="width:800px;float:left;">
                                	...
                                	<?php if(is_array($payments['onlines'])): $key = 0; $__LIST__ = $payments['onlines'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$payment): $mod = ($key % 2 );++$key; if($payment['isOnline'] == 1): ?><div style="float:left;width:165px;"><img src="/<?php echo ($payment['payIcon']); ?>" width="120" height="45"/></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                	<div style="clear:both;"></div>
                                </div>
                                <div style="clear:both;"></div>
                            </div><?php endif; ?>
                                        ...
                                        <div>
                                            <div class="wst-cart-goods-img">
                                                <a href="<?php echo U('Home/Goods/getGoodsDetails/',array('goodsId'=>$goods['goodsId']));?>" target="_blank">
                                                    <img src="/<?php echo ($goods['goodsThums']); ?>" width="60" height="60" /></a>
                                            </div>
...
<div class="wst-footer-hp-box">
	...
	function subCheckArea(){
	    ...
	    <?php if(is_array($shopColleges)): $key = 0; $__LIST__ = $shopColleges;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shopCollege): $mod = ($key % 2 );++$key;?>var shopCollege = ',<?php echo ($shopCollege); ?>,';
			...
			if(idx==-1){
				$("#areaOk").val("0");	
				alert("店铺“"+$("#sp_<?php echo ($key-1); ?>").html()+"”中的商品不在配送区域内！");
				return false;
			}else{
				$("#areaOk").val("1");
