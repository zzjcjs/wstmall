        ...
        <table class="table table-hover table-striped table-bordered wst-list">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td>
               <div>
               	<?php $__FOR_START_23859__=0;$__FOR_END_23859__=$vo['goodsScore'];for($i=$__FOR_START_23859__;$i < $__FOR_END_23859__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
				</td>
				<td>
				<div>
               	<?php $__FOR_START_26864__=0;$__FOR_END_26864__=$vo['timeScore'];for($i=$__FOR_START_26864__;$i < $__FOR_END_26864__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['timeScore']); ?> 分
				</div>
                </td>
                <td>
              	<div>
               	<?php $__FOR_START_32361__=0;$__FOR_END_32361__=$vo['serviceScore'];for($i=$__FOR_START_32361__;$i < $__FOR_END_32361__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['serviceScore']); ?> 分
				</div>
               </td>
               <td rowspan='2'>
